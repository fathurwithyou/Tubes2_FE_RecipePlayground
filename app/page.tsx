...
import { ArrowRight, Github, Code, Search, Cpu } from "lucide-react"
...
export default function Home() {
  ...
  return (
    <ThemeProvider defaultTheme="dark" storageKey="theme">
      ...
      <section className="min-h-screen bg-gradient-to-br from-gray-900 via-slate-900 to-zinc-900 flex flex-col items-center justify-center px-4 py-16">
        <div className="max-w-5xl w-full">
          <div className="text-center mb-12">
            ...
            >
              ...
              algorithms. Visualize the recipe trees and find multiple paths to your desired elements.
            </motion.p>
          ...
          >
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
              ...
              <div className="p-6 rounded-lg bg-black/30 border border-purple-900 backdrop-blur-sm">
                ...
                <h3 className="text-purple-400 font-medium text-xl mb-2">Animated Visualization</h3>
                <p className="text-gray-300">
                  Watch the recipe tree build step by step with beautiful animations showing how elements combine.
                </p>
              </div>
            </div>
          </motion.div>
      ...
      <section
        id="main-app"
        className="min-h-screen bg-gradient-to-br from-gray-900 via-slate-900 to-zinc-900 p-4 md:p-8"
      >
