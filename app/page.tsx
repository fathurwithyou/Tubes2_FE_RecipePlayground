...
import { ArrowRight, Github, Code, Search, Cpu, Layers } from "lucide-react"
  ...
  return (
    <ThemeProvider defaultTheme="dark" storageKey="theme">
      <div className="bg-gradient-to-br from-gray-900 via-slate-900 to-zinc-900 min-h-screen">
          ...
          <div className="max-w-5xl w-full">
            ...
            >
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
                <div className="p-6 rounded-lg bg-black/30 border border-purple-900 backdrop-blur-sm">
                  ...
                  <p className="text-gray-300">
                    Breadth-First Search finds the shortest recipe paths by exploring all possible combinations level by
                    level.
                  </p>
                </div>
                ...
                <div className="p-6 rounded-lg bg-black/30 border border-cyan-900 backdrop-blur-sm">
                  ...
                  <p className="text-gray-300">
                    Depth-First Search explores deep recipe combinations first, finding complex paths to create
                    elements.
                  </p>
                </div>
                ...
                <div className="p-6 rounded-lg bg-black/30 border border-purple-900 backdrop-blur-sm">
                  ...
                  <p className="text-gray-300">
                    Optimized with multithreading to efficiently search for multiple recipes in parallel, delivering
                    faster results.
                  </p>
                </div>
              </div>
              ...
              <div className="p-6 rounded-lg bg-black/30 border border-cyan-900 backdrop-blur-sm mb-12">
                ...
                <p className="text-gray-300">
                  Watch the recipe tree build step by step with beautiful animations showing how elements combine. Our
                  backend uses multithreading to optimize the search for multiple recipes, making the process faster and
                  more efficient. The visualization helps you understand the complex combinations needed to create your
                  desired elements.
                </p>
              </div>
            </motion.div>
            ...
            >
              ...
              <div className="flex items-center justify-center">
                ...
                <a
                  href="https://github.com/fathurwithyou/Tubes2_FE_RecipePlayground"
                  target="_blank"
                  rel="noopener noreferrer"
        ...
        <section id="main-app" className="min-h-screen p-4 md:p-8">
          <div className="container mx-auto max-w-6xl">
            <div className="mb-8 text-center">
              ...
              <p className="text-gray-300">
                Find recipes using BFS and DFS algorithms with multithreading optimization
              </p>
            </div>
            <RecipeFinder />
          </div>
