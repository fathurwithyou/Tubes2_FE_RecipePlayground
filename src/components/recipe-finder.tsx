...
import RecipeTree from "@/src/components/recipe-tree";
import { Loader2 } from "lucide-react";
import { motion } from "framer-motion";
import { fetchElements, searchRecipes } from "@/src/lib/api";
            ...
            <CardContent className="pt-6">
              <div className="flex flex-wrap gap-6 mb-6 p-4 bg-black/60 rounded-lg border border-purple-900/50">
                ...
                <div className="flex items-center">
                  ...
                  <span className="text-sm font-medium text-gray-300">Multithreading: Enabled</span>
                </div>
              </div>
